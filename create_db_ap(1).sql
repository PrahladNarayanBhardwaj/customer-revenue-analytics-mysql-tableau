...
DESCRIBE vendors;
select * from vendors; -- to view all the rows from the table
select * from vendors limit 10; -- limit function shows how much rows we want to look up

select * from vendors where vendor_state = "DC"; -- error